                ...
                <div class="flex justify-between">
                  ...
                  <div class="w-1/3">
                    <div class="mb-[30px] ml-[30px]">
                      <h6 class="text-base font-bold mb-[10px] text-[#abb7c4]">
                        Director:
                      </h6>
                      <p>
                        <a>{{ movie.director }}</a>
                    ...
                    <div class="mb-[30px] ml-[30px]">
                      ...
                      <p class="">
                        <span
                          class="text-xs bg-gray-400 rounded-md p-2 leading-10"
                          ><a>superhero</a></span
                        >
                        <span
                          class="text-xs bg-gray-400 rounded-md p-2 leading-10"
              ...
              <div id="reviews" class="tab review">
                <div class="">
                  <div class="flex justify-between items-center mb-10">
                    <div class="">
                      ...
                      <h2 class="text-2xl text-[#6497d9]">{{ movie.name }}</h2>
                    </div>
                    <button
                      class="
                        text-white
                ...
                >
                  <div class="user-infor">
                    ...
                    <img
                      v-else
                      src="/static/images/uploads/user-avatar-default-2.jpg"
                    />
                    <div>
                      <h3>{{ review.title }}</h3>
                      <div class="no-star">
